...
# src/webapp/assistants/general_support/tools/doc_comparison/doc_comparison.py
...
# =========================
UNKNOWN_TOKENS = {
    "", "-", "—", "n.v.t.", "nvt", "n/a", "na", "tbd", "onbekend", "niet ingevuld"
}
LABEL_REGEXES = [
...
# Annotaties (PDF)
# =========================
def add_highlight_with_note(page, text: str, color: Tuple[float, float, float], note: str) -> int:
    if not text:
        return 0
    try:
...
# UI helpers
# =========================
def show_pdf_inline(pdf_bytes: bytes, height: int = 800) -> None:
