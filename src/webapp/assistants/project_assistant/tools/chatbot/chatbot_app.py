...
Deze versie:
- draait ALTIJD binnen het bestaande Streamlit-proces;
- start GEEN tweede Streamlit-app meer;
- werkt naadloos met app.py of via registry.
"""
...
# -------------------------------------------------------
# UI runner — enkel binnen huidige Streamlit sessie
# -------------------------------------------------------
def run(*args: Any, **kwargs: Any) -> Any:
    """Start de Streamlit UI (nooit standalone)."""
